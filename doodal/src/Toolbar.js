...
import { FaFill, FaPalette } from "react-icons/fa";
...
function Toolbar({
    ...
    const toggleBackgroundColorOptions = () => {
        ...
        setShowBrushColorOptions(false); // Close brush color options when opening background color options
    };

    const toggleBrushColorOptions = () => {
        setShowBrushColorOptions(!showBrushColorOptions);
        setShowBackgroundColorOptions(false); // Close background color options when opening brush color options
    };
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "10px" }}>
            <ButtonToolbar aria-label="Drawing Toolbar">
                ...
                <div className="me-2">
                    <ButtonGroup>
                        <Button variant="primary" onClick={toggleBrushColorOptions}>
